...
class LazySingletonMongoDB:
    ...
    def __init__(self):
        if LazySingletonMongoDB._instance is not None:
...
# Usage
#m1 = LazySingletonMongoDB.get_instance()
#m2 = LazySingletonMongoDB.get_instance()
#print(id(m1) == id(m2))  # True — but NOT safe with threads!
...
test_thread_safety(LazySingletonMongoDB, "Lazy")
